...
function sayHelloButtonColor(){
    sayHelloButton.style.backgroundColor = 'purple'
    sayHelloButton.style.color = 'yellow'
}
...
function sayHelloButtonColorReset(){
    sayHelloButton.style.backgroundColor = ''
    sayHelloButton.style.color = ''
}
sayHelloButton.addEventListener('mouseout', sayHelloButtonColorReset)
...
queryBtn.addEventListener('click', getARequest)
